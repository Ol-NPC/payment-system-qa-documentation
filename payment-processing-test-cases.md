...
-	Например, для сумм от 30,00 USD требуется 3DS
-	29,99 USD - стоимость заказа соответствует максимальной сумме доступной без использования 3-D Secure. 
...
-	Создан заказ со статусом NEW
-	Например, для сумм от 30,00 USD требуется 3DS
-	30,00 USD - стоимость заказа соответствует минимальной сумме для оплат с 3-D Secure 
...
-	Заказ в статусе NEW
-	Например, для сумм от 30,00 USD требуется 3DS
-	заказ на 30,00 USD, стоимость заказа соответствует минимальной сумме для оплат с 3-D Secure
-	Пользователь находится на странице оплаты
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например, 15,00 USD минимальная сумма заказа для покупки.
-	Сумма созданного заказа равна 15,00 USD
-	Пользователь находится на странице оплаты
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например 999,99 USD максимальная сумма покупки.
-	Сумма созданного заказа равна 999,99 USD.
-	Пользователь находится на странице оплаты
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например, максимально допустимая сумма заказа 999,99 USD
-	1000,00 USD, сумма созданного заказа
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например, заказ формируется при суммах покупки от 15,00 USD
-	14,99 USD, сумма сощданного заказа
