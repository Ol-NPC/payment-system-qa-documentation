...
-	Стоимость заказа соответствует максимальной сумме доступной без использования 3-D Secure. (например 29,99 USD)
...
-	Создан заказ со статусом NEW
-	Для сумм от 30 USD требуется 3DS
-	Стоимость заказа соответствует минимальной сумме для оплат с 3-D Secure (например 30 USD)
...
-	Заказ в статусе NEW
-	Пользователь находится на странице оплаты
-	Пользователь вводит данные карты после окончания установленного времени ожидания / после разрыва соединение
...
-	Отображается сообщение о превышении времени ожидания.
...
-	Сумма заказа ниже минимальной суммы покупки (например, 14,00 $)
