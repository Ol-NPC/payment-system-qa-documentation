...
-	Для сумм от 30,00 USD требуется 3DS
...
-	Создан заказ со статусом NEW
-	Для сумм от 30,00 USD требуется 3DS
-	Например 30,00 USD, стоимость заказа соответствует минимальной сумме для оплат с 3-D Secure 
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например 15,00 USD. Сумма заказа равна минимальной сумме покупки.
-	Пользователь находится на странице оплаты
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Например 999,99 USD, сумма заказа равна максимальной сумме покупки.
-	Пользователь находится на странице оплаты
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Максимально допустимая сумма заказа 999,99 USD
-	Например, 1000,00 USD, сумма заказа превышает допустимый лимит 
...
-	Пользователь авторизован
-	Создан заказ со статусом NEW
-	Заказ формируется при суммах покупки от 15,00 USD
-	Например, 14,99 USD, сумма заказа ниже минимальной суммы покупки 
